...
You are a bold one!`}},render:(e,{argTypes:r})=>({components:{FSTextArea:Z,FSCol:M},props:Object.keys(r),setup(){return{...e}},template:`
    <FSCol>
      ...
      <FSTextArea
        ...
        v-model="args.value4"
      />
    </FSCol>`})},N={args:{args:{valid:!1,value1:"",value2:"",value3:"",rules:aa}},render:(e,{argTypes:r})=>({components:{FSForm:ea,FSTextArea:Z,FSCol:M,FSRow:Q},props:Object.keys(r),setup(){return{...e}},template:`
