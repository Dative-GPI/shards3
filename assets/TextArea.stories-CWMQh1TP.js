...
You are a bold one!`}},render:(e,{argTypes:s})=>({components:{FSTextArea:E,FSCol:H},props:Object.keys(s),setup(){return{...e}},template:`
    <FSCol>
      ...
      <FSTextArea
        ...
        v-model="args.value3"
      />
    </FSCol>`})},B={args:{args:{valid:!1,value1:"",value2:"",value3:"",rules:Qe}},render:(e,{argTypes:s})=>({components:{FSForm:Xe,FSTextArea:E,FSCol:H,FSRow:Je},props:Object.keys(s),setup(){return{...e}},template:`
    ...
    </FSForm>`})};var Q,Z,ee;P.parameters={...P.parameters,docs:{...(Q=P.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  args: {
    args: {
      value1: null,
      value2: "Hello there",
...
}`,...(re=(te=B.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};const ja=["Variations","Rules"];export{B as Rules,P as Variations,ja as __namedExportsOrder,Ea as default};
