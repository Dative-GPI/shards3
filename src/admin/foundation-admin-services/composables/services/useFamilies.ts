import type { FamilyDetailsDTO, FamilyFilters, FamilyInfosDTO } from "@dative-gpi/foundation-admin-domain/models";
import { FamilyDetails, FamilyInfos } from "@dative-gpi/foundation-admin-domain/models";
