...
export function mockApp() {
    ...
    onGetWithRegex("/api/foundation/core/v1/organisations/dative/folders/6", FOLDERS[5]);
    onGetWithRegex("/api/foundation/core/v1/organisations/dative/folders/7", FOLDERS[6]);
