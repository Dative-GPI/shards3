...
import { DASHBOARDORGANISATIONS, DEVICEORGANISATIONS, FOLDERS, GROUPS, IMAGES, LANGUAGES, TABLES, TIMEZONES, TRANSLATIONS } from '@/mocks';
import { DASHBOARDORGANISATIONTYPES } from '@/mocks/dashboardOrganisationTypes.mock';
